...
folder are mapped to the application's root namespace, 'TipgameApp'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "TipgameApp"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'TipgameApp' in the same way
as `"TipgameApp/sass/src"`.
